...
// //         const inputDni = screen.getByTestId("input_dni");
...
// //         const imageSendData = screen.getByTestId("image_send-data");
// //         const button = screen.getByRole("button", { name: /Send Data/i });
    
// //         expect(imageSendData).toBeInTheDocument();
// //         expect(imageSendData).toHaveStyle({
// //           width: "70%",
// //           height: "80%",
// //         });
