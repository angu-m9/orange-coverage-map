...
SELECT * FROM NetworkQualityMode;INSERT INTO NetworkQualityMode (city, most_common_network, frequency) VALUES ('Madrid','4g' ,'5');

INSERT INTO NetworkQualityMode (city, most_common_network, frequency) VALUES ('Barcelona','4g' ,'6');
INSERT INTO NetworkQualityMode (city, most_common_network, frequency) VALUES ('Madrid','4g' ,'5');ALTER USER 'root'@'localhost' IDENTIFIED BY 'Inxpirius_88';
